...
Hexadecimal [16-Bits]
                     ...
                     0005     8 max_entities == #05 ;numero máximo de entidades que se pueden crear
                             ...
                             14 
                             15 
   0000                      16 DefineComponentArrayStructure  _entity, max_entities, DefineCmp_Entity_default
...
Hexadecimal [16-Bits]
   ...
   40BF CC CC                 7 	.dw #0xCCCC		;últia posición del sprite en memoria de video (para utilizarla para el borrado del sprite)
                             17 
                             18 ;Para trabajar con entidades se necesita poner el puntero ix en el comienzo del array de entidades
                             19 ;RETURN a número de entidades
   40C1                      20 man_entity_getArray::
   40C1 DD 21 80 40   [14]   21 	ld ix, #_entity_array
   40C5 3A 7D 40      [13]   22 	ld a, (_entity_num)
   40C8 C9            [10]   23 ret
                             24 
                             25 ;se resetea el número de entidades a cero y se situa al principio del array el puntero _entity_pend
                             26 ;puntero que señala al byte donde se debe crear la nueva entidad (en este caso al principio) 
   40C9                      27 man_entity_init::
   40C9 AF            [ 4]   28 	xor a				;a=0
   40CA 32 7D 40      [13]   29 	ld (_entity_num), a	;iniciamos el número de unidades creadas a cero
                             30 
   40CD 21 80 40      [10]   31 	ld hl, #_entity_array	;hl apunta a la primera posición del array de entidades
   40D0 22 7E 40      [16]   32 	ld (_entity_pend), hl	;posición donde se creará la siguiente entidad => primera posición del array
                             33 
   40D3 C9            [10]   34 ret
                             35 
                             36 
                             37 ;INPUT HL => PUNTERO A VALORES DE INICIALIZACIÓN DE LA ENTIDAD A CREAR
                             38 ;RETURN ix => PUNTERO A LA ENTIDAD CREADA
   40D4                      39 man_entity_create::
   40D4 E5            [11]   40 	push hl			;man_entity_new destruye hl
   40D5 CD E0 40      [17]   41 	call man_entity_new
                             42 
   005B                      43 	ld__ixh_d
   40D8 DD 62                 1    .dw #0x62DD  ;; Opcode for ld ixh, d
   005D                      44 	ld__ixl_e	;instrucciones no comentadas de CPC (macro de cpctelera) ix = de puntero a la entidad añadida
   40DA DD 6B                 1    .dw #0x6BDD  ;; Opcode for ld ixl, e
                             45 
   40DC E1            [10]   46 	pop hl
   40DD ED B0         [21]   47 	ldir		;copia array hl en array de (tamaño del array bc)
                             48 
   40DF C9            [10]   49 ret
                             50 
                             51 ;se añade uno al contador de unidades y se mueve _entity_pend a la posición para crear la siguiente entidad
                             52 ;Devueleve los siguientes valores para el ldir
                             53 ;RETURN  	DE= PUNTERO AL NUEVO ELEMENTO A AÑADIR (AÑADIDO PERO SIN DATOS?)
                             54 ;		BC= TAMAÑO DE LA ENTIDAD PARA HACER EL LDIR sizeof_e		
   40E0                      55 man_entity_new::
   40E0 21 7D 40      [10]   56 	ld hl, #_entity_num
   40E3 34            [11]   57 	inc (hl)			;+1 ENTIDAD NUEVA CREADA
                             58 
   40E4 2A 7E 40      [16]   59 	ld hl,(_entity_pend)	;PUNTERO A LA DIRECCIÓN DE MEMORIA DONDE SE CREARÁ LA UNIDAD
                             60 
   40E7 54            [ 4]   61 	ld d, h
   40E8 5D            [ 4]   62 	ld e, l
...
Hexadecimal [16-Bits]
   ...
   40E9 01 0D 00      [10]   63 	ld bc, #sizeof_e
   40EC 09            [11]   64 	add hl, bc
   40ED 22 7E 40      [16]   65 	ld (_entity_pend), hl	;AHORA EL PUNTERO PARA LA CREAR LA SIGUIENTE UNIDAD SE MUEVE EL TAMAÑO DE UNA ENTIDAD EN EL ARRAY
                             66 
                             67 
   40F0 C9            [10]   68 ret
